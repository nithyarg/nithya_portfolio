...
const Hero = () => {
  return (
    <section className='py-12 xl:py-24 h-[84vh] xl:pt-28 bg-no-repeat 
        ...
        <div className='container mx-auto'>
            <div className='flex justify-between gap-x-8'>
             ...
             text-center xl:text-left'>
              <div className='text-sm uppercase font-semitbold mb-4 text-primary
              tracking-[4px]'>Web Developer</div>
              <h1 className='h1 mb-4'>Hello, my name is Nithya</h1>
              ...
              <div className='hidden xl:flex relative'>
                {/* badge 1 */}
                <Badge containerStyles="absolute top-[24%] -left-[5rem]" />
